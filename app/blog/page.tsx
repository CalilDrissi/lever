...
export const metadata: Metadata = {
  ...
  description:
    "Ideas, methods and experience reports for a calmer inbox and higher-leverage productivity.",
...
export default async function BlogIndexPage() {
  ...
  return (
    <PageShell>
      <PageHeader
        eyebrow="Blog"
        title="A calmer inbox, a clearer mind."
        lead="Ideas, methods and experience reports on productivity, email and leverage."
      />
